...
- Video: [Antescofo](https://youtu.be/I2VmJonTbKM?si=UzhQxHLJSFGfP5yr) (10 min)
...
### Wednesday · 19 February · Lab

- Tutorial: Github, RStudio, and flexdashboard (20 min)
- Demo: Plotly (10 min)
- Breakout 2: Visualising the class corpus (45 mins)
- Plenary Discussion: Breakout findings (15 mins)
...
## Breakout 2: Visualising the class corpus

**Before you begin this break-out session, convert your Github repository into a Github page with a (flex)dashboard.**

### Setup

We will start this analysis like every other analysis, by loading `tidyverse`.
